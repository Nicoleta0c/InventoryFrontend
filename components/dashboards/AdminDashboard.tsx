...
const AdminDashboard: React.FC = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "products":
        return <ProductsList userRole="Admin" />
      case "variations":
        return <ProductVariationsList userRole="Admin" />
      case "colors":
        return <ColorsList userRole="Admin" />
      case "prices":
        return <PricesList userRole="Admin" />
      case "users":
        return <UsersList userRole="Admin" />
      default:
        return <ProductsList userRole="Admin" />
    }
  }
    ...
    <Layout title="Admin Dashboard">
      <div className="space-y-6">
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <p className="text-gray-600">Full administrative access to all system resources.</p>
        </div>
